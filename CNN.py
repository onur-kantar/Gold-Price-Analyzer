...
Original file is located at
    https://colab.research.google.com/drive/12DJVhj-5isoLwXJEZJbRVF-aq5E7pwvr
"""
...
df = pd.read_csv("/content/drive/My Drive/Colab Notebooks/Gold Price Analysis/DS/gold_price_augment.csv", encoding = 'UTF-8', sep=',')
df
...
model.add(Conv1D(128, 16, activation='relu', input_shape=(x_train.shape[1], 1)))
